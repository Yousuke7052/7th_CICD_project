...
def get_current_branch():
    ...
    try:
        ...
        print('Failed to get current branch / 嘗試獲取prod分支失敗了: %s' % str(e))
        return None
...
def check_file_changed(file_path):
    ...
    try:
        ...
        print('Failed to check file changes / prod分支本次無提交oss靜態網站更新需求: %s' % str(e))
        return False
...
if __name__ == '__main__':
    ...
    if branch_name == 'prod':
        ...
        file_path = 'prod.html'  # DevOps中會在同級目錄下
        destination_path = 'prod.html'  # OSS中的暫定目標路徑
